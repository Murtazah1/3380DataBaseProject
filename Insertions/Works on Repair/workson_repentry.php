...
$sql = "INSERT INTO WORKSON_REP (EMPID, DEPID, REPID) VALUES (:empid, :depid, :repid)";
...
if ($result === true) {
        ...
        echo '<h1>Insert New Works on Repair Record</h1>';
        echo '</div>';
        ...
        echo "<p><strong>Repair ID:</strong> " . $repid . "</p>";
        echo '</div>';
...
<html>
<head>
	<title>Insert New Works on Repair Record</title>
    <style>
        .insert-record {
            display:block;
